...
def main():
    ...
    print(f"QRAC's with Non-Local States and Local Measurements (d={d}):")
    ...
    print("Success_Sigma_Opt_Phase1 = ", np.round(S, 3)) 
    ...
    print("Success_Measure_Opt_Phase2 = ", np.round(S1, 3))
